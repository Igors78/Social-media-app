...
RSpec.describe 'Friendship features', type: :request do
  before :each do
    User.create(name: 'Tadeu', email: 'tadeu@tadeu.com', password: '123123', password_confirmation: '123123')
    User.create(name: 'Maria', email: 'maria@maria.com', password: '123123', password_confirmation: '123123')
  end

  scenario 'Create and accept new friendship', js: true do
